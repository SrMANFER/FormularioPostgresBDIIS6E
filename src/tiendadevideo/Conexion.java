...
//String driver="com.mysql.jdbc.Driver";
    ...
    //String url="jdbc:mysql://localhost:3306/tiendadevideos2"; /** este nombre es el nombre de la base de datos? */
       
    String url= "jdbc:postgresql://localhost:5432/tienda_video";
...
this.user=user;  indica1=0; indica2=0;
try {
